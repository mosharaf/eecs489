...
### Due: Monday December 10th at 11:59 PM
...
* Please DO NOT submit any files other than source code. All other files (including `Makefile`) will be ignored during the grading process.
* We will use the Auto Testing Framework, and pull your repo to give you daily feedback. This process will start about halfway. **Details TBA**.
* The daily feedback is not your score. Upon midnight of due day and applicable late days, we will pull from the default branch of your repo, the content of which is counted as the submission.
