...
* You may find the following [UDP demo](https://github.com/mosharaf/eecs489/tree/master/Discussion/discussion7/udp) useful.
* You may also find the following [slides](https://github.com/mosharaf/eecs489/blob/master/Discussion/discussion7/UDP%20Reference%20Slides.pdf) useful as a reference for UDP programming.
...
* `Makefile`(s) to compile all everything with one single `make` command
